...
# Bernstein
- metodi per approssiamre.
- valutare differenza tra approssimante e approssimato.
- visulizzazione?
...
### domande
- quando valuto un polinomio di Bernstein, posso usare sempre la stessa formula (coefficient * basis) e mappre l'input a seconda della base?